...
/*			// Launch the DeviceListActivity to see devices and do scan
	...
	public void getValidString(String readMessage) {
		...
		if ((SystemClock.elapsedRealtime() - lastGUIUpdate) > 1500) {
			lastMessage = lastMessage + readMessage;
			if ((lastMessage.length() - lastMessage.replaceAll("E", "")
					.length()) >= 3) {
				String tokens[] = Pattern.compile("E").split(lastMessage);
...
//	 */
	...
	private void updateButtonBackground(String string, int batteryLevel,
		...
		if (string == "scooterBatteryLevel") {
			if (batteryLevel > 93) {
				((ImageView) findViewById(R.id.liqBatPic))
						.setImageResource(R.drawable.liq15);
			} else if (batteryLevel > 87) {
				((ImageView) findViewById(R.id.liqBatPic))
						.setImageResource(R.drawable.liq14);
			} else if (batteryLevel > 80) {
				((ImageView) findViewById(R.id.liqBatPic))
						.setImageResource(R.drawable.liq13);
			} else if (batteryLevel > 73) {
				((ImageView) findViewById(R.id.liqBatPic))
						.setImageResource(R.drawable.liq12);
			} else if (batteryLevel > 67) {
				((ImageView) findViewById(R.id.liqBatPic))
						.setImageResource(R.drawable.liq11);
			} else if (batteryLevel > 60) {
				((ImageView) findViewById(R.id.liqBatPic))
						.setImageResource(R.drawable.liq10);
			} else if (batteryLevel > 53) {
				((ImageView) findViewById(R.id.liqBatPic))
						.setImageResource(R.drawable.liq9);
			} else if (batteryLevel > 47) {
				((ImageView) findViewById(R.id.liqBatPic))
						.setImageResource(R.drawable.liq8);
			} else if (batteryLevel > 40) {
				((ImageView) findViewById(R.id.liqBatPic))
						.setImageResource(R.drawable.liq7);
			} else if (batteryLevel > 33) {
				((ImageView) findViewById(R.id.liqBatPic))
						.setImageResource(R.drawable.liq6);
			} else if (batteryLevel > 27) {
				((ImageView) findViewById(R.id.liqBatPic))
						.setImageResource(R.drawable.liq5);
			} else if (batteryLevel > 20) {
				((ImageView) findViewById(R.id.liqBatPic))
						.setImageResource(R.drawable.liq4);
			} else if (batteryLevel > 13) {
				((ImageView) findViewById(R.id.liqBatPic))
						.setImageResource(R.drawable.liq3);
			} else if (batteryLevel > 7) {
				((ImageView) findViewById(R.id.liqBatPic))
						.setImageResource(R.drawable.liq2);
			} else if (batteryLevel > 0 || batteryLevel <= 0) {
				((ImageView) findViewById(R.id.liqBatPic))
						.setImageResource(R.drawable.liq1);
			}
