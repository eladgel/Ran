...
import com.danbt.R;
import com.danbt.activities.DeviceListActivity;
 ...
 *
 */
public class MainActivityTemp extends Activity implements GPSCallback, LoaderManager.LoaderCallbacks<String> {
...
//	 */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        loader = (BTAsyncTaskLoader)getLoaderManager().initLoader(0, null, this);
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case Constants.MESSAGE_READ:
                    ...
                    if(readMessage.length() >= 24 * 3)
                    {
                        int indexOfFirstV = readMessage.indexOf('V');
                        if(indexOfFirstV != -1) {
                            readMessage = readMessage.substring(indexOfFirstV, readMessage.length() - 1);
...
//        readMessage.split(";");
//        Bundle b = new Bundle();
//                b.putString(MESSAGE,readMessage);
//                b.putLong(LAST_GUI_UPDATE, lastGUIUpdate);
//                b.putString(LAST_MESSAGE, lastMessage);

        // with support library:
        // call forceLoad() to start processing
        loader.setLastGuiUpdate(lastGUIUpdate);
        loader.setMsg(readMessage);
        loader.onContentChanged();
    }

    @Override
    public Loader onCreateLoader(int i, Bundle bundle) {
        return new BTAsyncTaskLoader(this);
    }
...
//        setLastMessage(strings[LAST_MSG_CELL]);
    }
